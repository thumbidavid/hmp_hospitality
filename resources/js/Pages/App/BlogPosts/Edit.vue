...
// Initialize form preloaded with data
const form = useForm({
    ...
    read_minutes: props.post.read_minutes || '',
...
const submit = () => {
    form.put(route('app.admin.blog-posts.update', props.post.id), {
        preserveScroll: true,
    })
}
</script>
...
<template>
    ...
    <AuthenticatedLayout>
        <PageBreadcrumb pageTitle="Edit Story" />
        ...
        <div class="mx-auto max-w-full pb-16">
            ...
            <form @submit.prevent="submit" class="space-y-8">
                <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    ...
                    <div class="space-y-6">
                        <!-- Cover Image Upload Box (Modified: Preloads current image) -->
                        <div
                            class="rounded-3xl border border-gray-100 bg-white p-6 dark:border-gray-800/50 dark:bg-gray-900">
                            ...
                            <FileUploader id="featured_image" v-model="form.featured_image"
                                :initial-file-url="post.featured_image_url" />
